...
function _resetPg2Cards() {
  ...
  if (sc) sc.innerHTML = `
    <div class="pg2-row hp-row" onclick="openAllFoldersSheet()">
      <div class="hp-icon-badge accent-5"><i class="fas fa-folder-open"></i></div>
      <div class="hp-row-label">My Folders</div>
      <span id="ccStarredBadge" class="hp-row-badge">${starredN}</span>
      <i class="fas fa-chevron-right hp-chevron"></i>
    </div>
    <div class="pg2-row hp-row" onclick="_collectGo('favourites')">
      <div class="hp-icon-badge accent-4"><svg viewBox="0 0 100 108" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:16px;height:16px;"><path d="M65.7 10.8 L65.8 43.4 L96.0 55.6 L65.0 65.7 L62.7 98.2 L43.5 71.9 L11.9 79.7 L31.0 53.3 L13.8 25.7 L44.8 35.7 Z" stroke="currentColor" stroke-width="9" stroke-linejoin="round"/></svg></div>
      <div class="hp-row-label">Picked</div>
      <span id="ccFavsBadge" class="hp-row-badge">${favsN}</span>
      <i class="fas fa-chevron-right hp-chevron"></i>
    </div>`;
