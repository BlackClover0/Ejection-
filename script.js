...
function openCloudModal() {
  ...
  if (m) { _tgRefreshStatusUI(); clearTimeout(m._closeT); m.classList.remove('closing'); m.classList.add('open'); }
}
...
function openRetrieveModal() {
  ...
  if (!m) return;
  clearTimeout(m._closeT); m.classList.remove('closing'); m.classList.add('open');
