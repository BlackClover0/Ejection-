...
(function () {
  ...
  function updateDateTime() {
    ...
    var heroDate = weekdayName + ', ' + now.getDate() + ' ' + MONTHS_FULL[now.getMonth()] + ', ' + now.getFullYear();
...
let _dsGridCols = parseInt(localStorage.getItem('pv_homeGrid') || '4');
let _dsReduceMotion = localStorage.getItem('pv_reduceMotion') === '1';
